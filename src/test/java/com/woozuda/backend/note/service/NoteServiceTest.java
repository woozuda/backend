...
class NoteServiceTest {
    ...
    NoteResponseDto commonNote2 = new NoteResponseDto(2L, 2L, "diary2", "common note2", "2024-12-10", "CLEAR", "SUMMER", "CONTENT", List.of("common content2"));

    NoteResponseDto questionNote1 = new NoteResponseDto(3L, 1L, "diary3", "question note1", "2024-12-07", "PARTLY_CLOUDY", "FALL", "HAPPINESS", "question1", List.of("question content1"));
    NoteResponseDto questionNote2 = new NoteResponseDto(4L, 2L, "diary2", "question note2", "2024-12-10", "CLOUDY", "WINTER", "NEUTRAL", "question2", List.of("question content2"));

    NoteResponseDto retrospectiveNote1 = new NoteResponseDto(6L, 1L, "diary3", "retrospective note2", "2024-06-05", "SCS", List.of("retrospective2 content1", "retrospective2 content2", "retrospective2 content3"));
    NoteResponseDto retrospectiveNote2 = new NoteResponseDto(5L, 2L, "diary1", "retrospective note1", "2024-12-11", "FOUR_F_S", List.of("retrospective1 content1", "retrospective1 content2", "retrospective1 content3", "retrospective1 content4"));
